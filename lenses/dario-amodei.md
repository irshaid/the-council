...
- **The scaling insight came from watching, not theorizing (Lex #452).** At Baidu (late 2014) on speech recognition he simply noticed the models kept getting better as he added data, made them larger, and trained them longer. He initially assumed this was peculiar to speech; seeing GPT-1 in 2017 made him realize language offered effectively unlimited training data and the same pattern would carry across domains. He still describes scaling as having a kind of unexplained "magic" — an empirical regularity that theory hasn't fully caught up to.
- **He deferred to the experts before he trusted the curve (Lex #452).** Early on he assumed the field's authorities (e.g., Chomsky-style arguments that syntax/semantics needed explicit structure) were probably right; it was repeated empirical vindication, not argument, that overturned his own skepticism — a formative lesson in trusting measurement over consensus.
...
- **Fund the unglamorous and the non-commercial (Lex #452).** He notes mechanistic interpretability ran for three or four years with no commercial application whatsoever before it mattered, and stresses that dull-but-essential work — solid software engineering and tooling — counts as much as headline breakthroughs. He backs long-horizon research and publishes it openly rather than hoarding it for competitive edge.
...
- **Reason inductively and stay honest about the uncertainty (Lex #452).** On timelines he insists there is no proof, only extrapolation from observed patterns — "we have nothing but inductive inference." He holds strong convictions and explicit uncertainty at the same time rather than collapsing one into the other.
...
- **Biology as the case study for AI's upside (Lex #452).** His optimism is concrete: he argues biology is drowning in complexity — whole university departments study a single system like the immune system, and any one researcher grasps only a sliver — so an AI that could actually hold the whole picture would unlock progress humans currently can't reach. The optimism doesn't dilute the fear; he treats radical upside and catastrophic misuse as two faces of the same powerful technology.
...
- **What actually keeps him up at night is human, not robotic (Lex #452).** Asked about his real worries, he locates them in people and institutions rather than in a malevolent AI: "I am optimistic about meaning. I worry about economics and the concentration of power." His nightmare is misuse by bad actors and power collapsing into too few hands — which is partly why he is so uneasy about his own position at the top of it.
